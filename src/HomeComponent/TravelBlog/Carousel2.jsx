...
import img1 from "/Thumbnail/travel1.png"
import img2 from "/Thumbnail/travel2.png"
import img3 from "/Thumbnail/travel3.png"
        ...
        <div className="max-w-6xl mx-auto h-[540px] md:h-[670px] flex flex-col xl:flex-row items-center overflow-hidden gap-5 lg:gap-10 relative">
            ...
            <div className="h-[540px] md:h-[670px] w-2/3 ml-auto relative ease-linear duration-300 flex items-center"
                ...
                {sliders.map((slide, inx) => (
                    <div key={inx}
                        className={`${currentSlider === inx ? "h-[240px] sm:h-[310px] md:h-[480px] lg:h-[500px]" : "h-[220px] sm:h-[260px] md:h-[380px] lg:h-[460px] scale-95 opacity-40"} min-w-[50%] relative duration-200`}
